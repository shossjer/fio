...
namespace fio
{
	...
	namespace detail
	{
		inline wchar_t * to_chars(uint8 value, wchar_t * buffer)
		{
			//   255
			//   abc
			// x 111 1
		...
		inline wchar_t * to_chars(uint16 value, wchar_t * buffer)
		{
			//   65 535
			//   ab cde
			// x 11 112 222
		...
		inline wchar_t * to_chars(uint32 value, wchar_t * buffer)
		{
			//   4 294 967 295
			//   a bcd efg hij
			// x 1 111 222 233 33
		...
		inline wchar_t * to_chars(uint64 value, wchar_t * buffer)
		{
			//   18 446 744 073 709 551 615
			//   ab cde fgh ijk lmn opq rst
			// x 11 112 222 333 344 44
